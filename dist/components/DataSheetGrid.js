...
exports.DataSheetGrid = react_1.default.memo(react_1.default.forwardRef(function (_a, ref) {
    ...
    var beforeTabIndexRef = react_1.useRef(null);
    var afterTabIndexRef = react_1.useRef(null);
    ...
    var onCopy = react_1.useCallback(function (event) {
        ...
        if (!editing && activeCell) {
            ...
            for (var row = min.row; row <= max.row; ++row) {
                copyData.push([]);
                for (var col = min.col; col <= max.col; ++col) {
                    var _c = columns[col + 1].copyValue, copyValue = _c === void 0 ? function () { return null; } : _c;
            ...
            (_b = event.clipboardData) === null || _b === void 0 ? void 0 : _b.setData('text/html', "<table>" + copyData
                ...
                return "<tr>" + row
                    .map(function (cell) {
                    return "<td>" + html_entities_1.encode(String(cell !== null && cell !== void 0 ? cell : '')).replace(/\n/g, '<br/>') + "</td>";
                })
                    .join('') + "</tr>";
            })
                .join('') + "</table>");
    ...
    var onPaste = react_1.useCallback(function (event) { return __awaiter(void 0, void 0, void 0, function () {
        var pasteData, min, max, newData, columnIndex, pasteValue, rowIndex, _a, _b, newData, missingRows, columnIndex, pasteValue, rowIndex, _c, _d;
        ...
        return __generator(this, function (_o) {
            switch (_o.label) {
                case 0:
                    ...
                    pasteData = [['']];
                    if ((_e = event.clipboardData) === null || _e === void 0 ? void 0 : _e.types.includes('text/html')) {
                        pasteData = copyPasting_1.parseTextHtmlData((_f = event.clipboardData) === null || _f === void 0 ? void 0 : _f.getData('text/html'));
                    }
                    else if ((_g = event.clipboardData) === null || _g === void 0 ? void 0 : _g.types.includes('text/plain')) {
                        pasteData = copyPasting_1.parseData2((_h = event.clipboardData) === null || _h === void 0 ? void 0 : _h.getData('text/plain'));
                    }
                    else if ((_j = event.clipboardData) === null || _j === void 0 ? void 0 : _j.types.includes('text')) {
                        pasteData = copyPasting_1.parseData2((_k = event.clipboardData) === null || _k === void 0 ? void 0 : _k.getData('text'));
                    }
                ...
                case 1:
                    ...
                    pasteValue = (_l = columns[min.col + columnIndex + 1]) === null || _l === void 0 ? void 0 : _l.pasteValue;
                ...
                case 8:
                    ...
                    pasteValue = (_m = columns[min.col + columnIndex + 1]) === null || _m === void 0 ? void 0 : _m.pasteValue;
    ...
    var onKeyDown = react_1.useCallback(function (event) {
        ...
        if (event.key === 'Tab' &&
            ...
            setSelectionCell(null);
            setEditing(false);
            var allElements = tab_1.getAllTabbableElements();
            var index = allElements.indexOf(afterTabIndexRef.current);
        ...
        if (event.key === 'Tab' &&
            ...
            setEditing(false);
            var allElements = tab_1.getAllTabbableElements();
            var index = allElements.indexOf(beforeTabIndexRef.current);
    ...
    react_1.useImperativeHandle(ref, function () { return ({
        ...
        setSelection: function (value) {
            var selection = typeCheck_1.getSelection(value, columns.length - (hasStickyRightColumn ? 2 : 1), data.length, columns);
        ...
        setActiveCell: function (value) {
            var cell = typeCheck_1.getCell(value, columns.length - (hasStickyRightColumn ? 2 : 1), data.length, columns);
            setActiveCell(cell);
            setEditing(false);
            setSelectionMode({ columns: false, active: false, rows: false });
            setSelectionCell(null);
    ...
    return (react_1.default.createElement("div", { className: className, style: style },
        react_1.default.createElement("div", { ref: beforeTabIndexRef, tabIndex: rawColumns.length && data.length ? 0 : undefined, onFocus: function (e) {
                e.target.blur();
                setActiveCell({ col: 0, row: 0 });
            } }),
        ...
        react_1.default.createElement("div", { ref: afterTabIndexRef, tabIndex: rawColumns.length && data.length ? 0 : undefined, onFocus: function (e) {
                e.target.blur();
                setActiveCell({
                    col: columns.length - (hasStickyRightColumn ? 3 : 2),
                    row: data.length - 1,
